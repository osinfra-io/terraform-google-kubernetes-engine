...
resource "google_container_node_pool" "this" {
  ...
  management {
    ...
    # Node auto-upgrades help you keep the nodes in your cluster up-to-date with the cluster control plane version when your control plane is updated on your behalf.
